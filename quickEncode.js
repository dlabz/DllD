...
//  Input file.
const INPUT_PATH = Path.join(__dirname,"public", "input.raw");

//  Output file.
const OUTPUT_PATH = Path.join(__dirname,"public", "output.lc3");
...
(function() {
    ...
    //  Open output file.
    let outfd = FS.openSync(OUTPUT_PATH, FS.constants.O_WRONLY | FS.constants.O_TRUNC | FS.constants.O_CREAT);
